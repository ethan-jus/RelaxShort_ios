...
**Files:**
- Create: `/Users/ethan/myspance/relaxshort/app-server/v2/src/main/resources/db/migration/V16__watch_session_idempotency.sql`
...
`/Users/ethan/myspance/relaxshort/ios/v1.0.0/docs/CC_TASK31_MY_LIST_VISUAL_CONTRACT.md`

CC 不需要识别原始截图；该视觉合同是 Codex 检查参考图后整理的唯一文字输入。
...
用 `docker-compose.mysql.yml` 的 MySQL 8.4 新建临时空库，执行 Flyway V1-V16，
