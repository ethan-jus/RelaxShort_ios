...
enum APIEndpoint {
    ...
    case forYou(cursor: String?, limit: Int, contentLanguage: String?, countryCode: String?, feedSeed: String?, strictContentLanguage: Bool)
    /// 某部短剧的所有剧集
...
extension APIEndpoint {
    ...
    var url: URL? {
        ...
        switch self {
        case .forYou(let cursor, let limit, let contentLanguage, let countryCode, let feedSeed, let strictContentLanguage):
            ...
            if strictContentLanguage {
                items.append(URLQueryItem(name: "strict_content_language", value: "true"))
            }
