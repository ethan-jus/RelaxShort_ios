...
enum MockData {
    ...
    static let vipPlans: [VIPPlan] = [
        VIPPlan(id: "weekly", title: "周会员", price: "member.price_unavailable".localized, originalPrice: nil, period: "/周", isRecommended: false, description: nil, dailyPrice: nil, discountPercent: nil),
        VIPPlan(id: "monthly", title: "月会员", price: "member.price_unavailable".localized, originalPrice: nil, period: "/月", isRecommended: true, description: nil, dailyPrice: nil, discountPercent: nil),
        VIPPlan(id: "yearly", title: "年会员", price: "member.price_unavailable".localized, originalPrice: nil, period: "/年", isRecommended: false, description: nil, dailyPrice: nil, discountPercent: nil),
    ]
