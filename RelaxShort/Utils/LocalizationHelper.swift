...
enum L10n {
    ...
    private static let zhFallback: [String: String] = [
        ...
        "member.benefit.exclusive": "会员专属剧集",
        ...
        "profile.membership_benefit_series": "16K+ 剧集",
        "profile.membership_benefit_points": "每日积分",
        "profile.membership_benefit_download": "离线下载",
        "profile.membership_benefit_quality": "1080p 画质",
        "profile.top_up": "充值",
